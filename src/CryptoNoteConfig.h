...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1c2b;
...
const char     CRYPTONOTE_NAME[]                             = "Veritas";
...
const int      P2P_DEFAULT_PORT                              = 16109;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 16209;
